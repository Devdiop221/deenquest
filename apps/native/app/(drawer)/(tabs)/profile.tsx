      ...
      <View className="p-6">
        ...
        <View className="flex-row bg-deen-primary rounded-2xl p-1 mb-6">
          <TouchableOpacity className="flex-1 py-3 bg-deen-primary rounded-2xl">
            <Text className="text-white text-center" style={{ fontFamily: 'Urbanist_600SemiBold' }}>
              Weekly
            </Text>
          </TouchableOpacity>
          <TouchableOpacity className="flex-1 py-3">
            <Text className="text-white text-center" style={{ fontFamily: 'Urbanist_400Regular' }}>
              All Time
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View className="items-center mb-8">
          <View className="relative">
            ...
            <View className="absolute -bottom-2 -right-2 w-8 h-8 bg-orange-400 rounded-full items-center justify-center">
              <Text className="text-white text-sm" style={{ fontFamily: 'Urbanist_700Bold' }}>
                1
              </Text>
            </View>
          </View>
          <Text className="text-deen-dark text-lg mt-2" style={{ fontFamily: 'SpaceGrotesk_600SemiBold' }}>
            You
          </Text>
        </View>
        ...
        <View className="bg-white rounded-2xl p-4">
          ...
          <View className="flex-row bg-deen-primary rounded-xl p-3 mb-4">
            <Text className="text-white flex-1 text-center" style={{ fontFamily: 'Urbanist_600SemiBold' }}>
              Rank
            </Text>
            <Text className="text-white flex-1 text-center" style={{ fontFamily: 'Urbanist_600SemiBold' }}>
              Name
          ...
          {[
            ...
            <View key={index} className="flex-row py-3 border-b border-gray-100">
              <Text className="text-gray-600 flex-1 text-center" style={{ fontFamily: 'Urbanist_400Regular' }}>
                {entry.rank}
              </Text>
              <Text className="text-deen-dark flex-1 text-center" style={{ fontFamily: 'Urbanist_500Medium' }}>
                {entry.name}
              </Text>
              <Text className="text-deen-dark flex-1 text-center" style={{ fontFamily: 'Urbanist_600SemiBold' }}>
                {entry.points}
              </Text>
            </View>
          ))}
        ...
        <View className="mt-6 bg-white rounded-2xl p-4">
          ...
          <View className="flex-row justify-between">
            ...
            <View className="items-center">
              <Text className="text-2xl text-orange-500" style={{ fontFamily: 'SpaceGrotesk_700Bold' }}>
                {stats?.level || 1}
              </Text>
              <Text className="text-gray-600 text-sm" style={{ fontFamily: 'Urbanist_400Regular' }}>
                Level
            ...
            <View className="items-center">
              <Text className="text-2xl text-purple-600" style={{ fontFamily: 'SpaceGrotesk_700Bold' }}>
                {stats?.totalXp || 0}
              </Text>
              <Text className="text-gray-600 text-sm" style={{ fontFamily: 'Urbanist_400Regular' }}>
                XP
